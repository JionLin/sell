...
参数 returnUrl: http://xxx.com/abc  //【必填】
返回
http://xxx.com/abc?openid=oZxSYw5ldcxv6H0EU67GgSXOUrVg
http://i8hunm.natappfree.cc/sell/wechat/authorize?returnUrl=https://www.baidu.com/
*/
	...
	public String qrAuthorize(@RequestParam("returnUrl") String returnUrl) {
		String url = projectUrlConfig.getWechatOpenAuthor() + "/sell/wechat/qrUserInfo";
